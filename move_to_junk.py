...
def is_spam_indicator(msg_obj, from_addr, to_addrs, cc_addrs):
    ...
    # 2. Check for suspicious Return-Path mismatch
    ...
    # 3. Check if From domain is suspicious (very long, random)
...
def main():
    ...
    for i, num in enumerate(msg_ids):
        try:
            ...
            elif not has_valid_address or spam_reasons or ovh_spam:
